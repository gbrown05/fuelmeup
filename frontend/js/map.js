...
function createMarker(currStation, ctr){
	...
	var content = "<div class=cont><p>"+currStation.station +'</p><p> Listed Price: $' + currStation.price + ' per gallon </p> <p>  Distance: ' + currStation.distance + '</p> <p> Fuel Me Up Price: $' + (Math.round(price*100) / 100) + '</p> <p> Gas Buddy Price: $'+ (Math.round((currStation.price * tankSize * gasAmount) * 100) / 100) + '</p></div>';
